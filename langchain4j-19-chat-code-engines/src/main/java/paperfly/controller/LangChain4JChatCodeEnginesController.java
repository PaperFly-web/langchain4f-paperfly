...
@RequestMapping("/lc4j")
@Slf4j
public class LangChain4JChatCodeEnginesController {
    @Autowired
    ...
    @RequestMapping(value = "/code/engines/ask")
    ...
    @RequestMapping(value = "/code/engines/query")
    ...
    @RequestMapping(value = "/code/engines/query2")
